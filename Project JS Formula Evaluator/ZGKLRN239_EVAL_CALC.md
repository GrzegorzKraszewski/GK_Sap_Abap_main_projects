...
<p>This tool provides two main options => you can check the  calculations/formula using some of the js notation and  it gives possibilites to manage the  calculations/formula ( save, edit, delete in/from Data Base )  </p>
